...
import { Download, MapPin, Briefcase, GraduationCap, Award, Globe } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <div>
              <div className="flex items-center mb-6">
                <GraduationCap className="w-6 h-6 text-blue-600 dark:text-green-400 mr-3" />
              ...
              <div className="space-y-6">
                {education.map((edu, index) => (
                  <div key={index} className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg border border-gray-200 dark:border-gray-700 transition-colors duration-300">
                    ...
                    <div className="text-green-600 dark:text-green-400 font-medium mb-2 transition-colors duration-300">{edu.school}</div>
          ...
          <div>
            <div className="flex items-center mb-6">
              <Award className="w-6 h-6 text-blue-600 dark:text-yellow-400 mr-3" />
            ...
            <div className="space-y-4">
              ...
              <div className="mt-8">
                <div className="flex items-center mb-4">
                  <Globe className="w-6 h-6 text-green-600 dark:text-red-400 mr-3" />
                  <h4 className="text-xl font-bold text-gray-900 dark:text-white">Languages</h4>
                </div>
                <div className="space-y-4">
                  {languages.map((lang, index) => (
                    ...
                    >
                      <div className="flex items-start">
                        <div className="w-2 h-2 bg-blue-600 dark:bg-blue-400 rounded-full mt-2 mr-3 flex-shrink-0"></div>
                        <span className="text-gray-700 dark:text-gray-300 font-medium transition-colors duration-300">{lang}</span>
                      </div>
                    </div>
                  ))}
                </div>
